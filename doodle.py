...
class Paint:
    ...
    def __init__(self,root):
        ...
        colors=["#000000","#FFFFFF","#FF0000","#00FF00","#0000FF","#FFFF00","#00FFFF","#FF00FF","#FFC0CB","#800080","#00FFFF","#808080"]
        i=j=0
        for color in colors:
        ...
        self.traingle_btn = Button(root, image=self.traingle_img, fg="red", bg="white",
                                   font=("Arial", 10, "bold"), relief=RAISED, bd=3, command=None)
        self.traingle_btn.place(x=37, y=455)
    ...
    def paint_app(self,event):
        ...
        self.canvas.create_oval(x_start, y_start, x_final, y_final,fill="black",outline="black",width=self.pen_size1.get())
